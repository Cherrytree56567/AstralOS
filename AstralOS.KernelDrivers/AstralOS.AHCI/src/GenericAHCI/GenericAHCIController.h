...
class GenericAHCIControllerFactory : public BlockControllerFactory {
public:
    virtual ~GenericAHCIControllerFactory() override {}
    virtual bool Supports(const DeviceKey& devKey) override;
    virtual BlockController* CreateDevice() override;
};

class GenericAHCIController : public BlockController {
public:
